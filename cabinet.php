...
//
// 5.6.6 → 5.6.7: СКРОЛ СИДБАРУ РОБИМО СПІЛЬНИМ З ОСНОВНОЮ СТОРІНКОЮ:
//                Прибрано position: sticky + overflow-y: auto + height: calc(100vh - ...) зі сидбару.
//                Раніше сидбар був sticky з власним скролом — є два окремих скроли (сидбар + main),
//                незручно. Тепер сидбар — звичайний flex-item, скролиться разом з main через єдиний body
//                scrollbar (стандартний брендовий з base.css). + .app align-items: flex-start щоб сидбар
//                не розтягувався на висоту main.
//
// 5.6.7 → 5.6.8: СИДБАР РОЗТЯГУЄТЬСЯ НА ПОВНУ ВИСОТУ СТОРІНКИ:
//                Прибрано align-items: flex-start з .app — повернули до default flex stretch.
//                Сидбар тепер розтягується на всю висоту .app (рівняється висоті main або min 100vh).
//                Gradient border (rose-violet-orange) відтепер розтягнутий рівною висотою зі сторінкою —
//                виглядає візуально збалансовано на будь-якій довжині контенту.
$cssVer = '5.6.8';
?><!DOCTYPE html>
<html lang="ru">
<head>
